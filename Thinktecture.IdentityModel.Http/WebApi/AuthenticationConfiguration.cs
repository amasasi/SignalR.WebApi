...
namespace Thinktecture.IdentityModel.Http
{
    ...
    {
        HttpSecurityTokenHandlerCollectionManager _manager;
        ...
        public HttpSecurityTokenHandlerCollectionManager Handler
        {
            get { return _manager; }
        }
        ...
        public AuthenticationConfiguration()
        {
            ...
            _manager = new HttpSecurityTokenHandlerCollectionManager();
        }
    }
}
