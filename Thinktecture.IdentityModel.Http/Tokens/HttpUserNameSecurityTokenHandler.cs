...
namespace Thinktecture.IdentityModel.Http
{
    ...
    /// </summary>
    public class HttpUserNameSecurityTokenHandler : UserNameSecurityTokenHandler, IHttpSecurityTokenHandler
    {
        ...
        /// </summary>
        public HttpUserNameSecurityTokenHandler()
        { }
        ...
        public HttpUserNameSecurityTokenHandler(ValidateUserNameCredentialDelegate validateUserNameCredential)
        {
